...
public class BeforeTest {
	...
	public void logService(JoinPoint jp) { // JoinPoint인터페이스는 항상 첫번째 매개변수로 작성되어야 함
		
		StringBuilder sb = new StringBuilder();
		sb.append("==================================================\n");
		
		// start : 실행된 클래스명 - 실행된 메서드(매개변수)
		// JoinPoint : getTarget() -> AOP가 적용된 객체를 반환(XXXserviceImpl)
		sb.append("start : "+jp.getTarget().getClass().getSimpleName()+" - "); // 패키지명을 제외한 클래스명을 반환시켜줌
